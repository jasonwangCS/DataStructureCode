...
public class Path
{
    public static int dijkstras(char[][] grid, ArrayList<TerrainCost> travelCosts)
    {
     ...
     public static void main(String[] args) {
        ...
        travelCosts.add(new TerrainCost('E', 1));
        travelCosts.add(new TerrainCost('M', 8));
        travelCosts.add(new TerrainCost('F', 4));
        travelCosts.add(new TerrainCost('G', 1));
        travelCosts.add(new TerrainCost('I', -1));
        travelCosts.add(new TerrainCost('W', 5));
        int ret = dijkstras(grid, travelCosts);
        System.out.println(ret + "YAY");
    }
}
